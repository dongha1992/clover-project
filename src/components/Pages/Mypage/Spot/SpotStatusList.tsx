              ...
              return (
                ...
                <Wrppaer key={item.id}>
                  <FlexBetween margin='0 0 6px 0'>
                    <Flex>
                      <TextH5B color={theme.brandColor} margin='0 8px 0 0'>{item.status}</TextH5B>
                      <Tag color={theme.brandColor} backgroundColor={theme.brandColor5}>{item.tag}</Tag>
                    </Flex>
                  ...
                  <TextB3R>{item.address}</TextB3R>
                  {
                    ...
                    <FlexStart margin='4px 0 0 0'>
                      <SVGIcon name='people' />
                      <TextH6B margin='0 0 0 6px' color={theme.brandColor}>{`${item.number}/5명 참여 중`}</TextH6B>
                    </FlexStart>
                  }
                  {
                    item.btn !== null &&
