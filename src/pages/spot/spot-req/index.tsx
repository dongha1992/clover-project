...
import {TextH2B, TextB3R, TextH3B} from '@components/Text';
...
function spotReq() {
    ...
    const text = {
        ...
        privateDesc: '우리 회사 학교에서 점심 저녁 원하는 시간으로\n샐러드 무료로 배송받기',
  ...
  return(
      <Container>
        <TopWrapper>
          ...
          <TextB3R margin='33px 0 48px 0' color={theme.greyScale65}>{mainText()?.text2}</TextB3R>
        </TopWrapper>
        <GuideWrapper>
          <Guide></Guide>
        </GuideWrapper>
